...
public class TitleBarTools {
    ...
    public TitleBarTools setOnMenuItemClickListener(Toolbar.OnMenuItemClickListener
    ...
    public TitleBarTools defaultToolBar(View.OnClickListener onClickListener) {
        setNavigationIcon(R.mipmap.icon_back).setNavButtonId().setNavigationListener
                (onClickListener);
        return this;
    }
