...
import com.app.CarCia.adapters.CommonExpandableAdapter;
...
public class ArrayListViewTools {
     ...
     * @param absListView
     */
    protected static void measureAbsListViewHeight(ViewGroup absListView) {
     ...
     */
    protected static void expandGroup(ExpandableListView expandableListView, boolean isExpand) {
